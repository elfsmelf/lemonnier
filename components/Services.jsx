...
const svcs = [
  ...
  {
    t: "Front yard landscaping",
    d: "Arrival gardens that add kerb appeal and value. Driveways, entries, lawn, and feature planting.",
    img: images.lawnNewLandscape,
    alt: "Front yard landscaping Perth — new garden and lawn",
  },
  {
    t: "Turf installation",
    d: "Real and synthetic turf laid to last — properly prepped, levelled, and finished for a green lawn year-round.",
    img: images.grass,
    alt: "Turf installation Perth — fresh lawn laid",
  },
  {
